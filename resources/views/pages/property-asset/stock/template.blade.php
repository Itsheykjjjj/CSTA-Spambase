...
@section('title')
  Stocks Masterlist | CSTA - Spambase
@endsection
  ...
  <div class="content container-fluid">
        ...
        <div class="col-sm mb-2 mb-sm-0">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              ...
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="">Property & Assets</a></li>
              <li class="breadcrumb-item active" aria-current="page">Stocks</li>
            </ol>
          </nav>

          <h1 class="page-header-title">Stocks Masterlist</h1>
        </div>
        <!-- End Col -->

        <div class="col-sm-auto">
          <a class="btn btn-primary" href="">
            <i class="bi-person-plus-fill me-1"></i> Add Stock
          </a>
        </div>
        <!-- End Col -->
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
        ...
        <div class="card h-100">
          <div class="card-body">
            <h6 class="card-subtitle mb-2">Active Stocks</h6>
    ...
    <div class="card">
      ...
      <div class="card-header card-header-content-md-between">
        <div class="mb-2 mb-md-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" type="search" class="form-control" placeholder="Search stocks" aria-label="Search stocks">
            </div>
            <!-- End Search -->
          </form>
        </div>
        ...
        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
          ...
          <!-- Dropdown -->
          <div class="dropdown">
            <button class="btn btn-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasStockFilter" aria-controls="offcanvasStockFilter">
