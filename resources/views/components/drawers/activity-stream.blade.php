...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasActivityStream" aria-labelledby="offcanvasActivityStreamLabel">
  ...
  <div class="offcanvas-body">
      ...
      <li class="step-item">
        <div class="step-content-wrapper">
          ...
          <div class="step-content">
            ...
            <p class="fs-5 mb-1">Marked <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fr-6</a> as <span
                class="badge bg-soft-success text-success rounded-pill"><span class="legend-indicator bg-success"></span>"Completed"</span></p>
      ...
      <li class="step-item">
        <div class="step-content-wrapper">
          ...
          <div class="step-content">
            ...
            <p class="fs-5 mb-1">Marked <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fr-3</a> as <span
                class="badge bg-soft-success text-success rounded-pill"><span class="legend-indicator bg-success"></span>"Completed"</span></p>
      ...
      <li class="step-item">
        <div class="step-content-wrapper">
          ...
          <div class="step-content">
            ...
            <p class="fs-5 mb-1">Marked <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fr-3</a> as <span
                class="badge bg-soft-primary text-primary rounded-pill"><span class="legend-indicator bg-primary"></span>"In progress"</span></p>
    ...
    <div class="d-grid">
      <a class="btn btn-white" href="#">View all <i class="bi-chevron-right"></i></a>
    </div>
  </div>
</div>
<!-- End Activity -->
