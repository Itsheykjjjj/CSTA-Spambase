const HSThemeAppearance = {
  ...
  visiblilityAttributeName: "data-hs-theme-appearance",
  ...
  _setVisablilityStyles(theme) {
    ...
    $style.textContent = `[${this.visiblilityAttributeName}]:not([${this.visiblilityAttributeName}='${theme}']){display:none!important;}`;
  },
